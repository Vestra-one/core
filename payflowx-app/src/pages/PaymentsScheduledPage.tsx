...
export function PaymentsScheduledPage() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#101022] text-white">
      <aside className="w-64 border-r border-[#282839] flex flex-col bg-[#101022] shrink-0">
        <div className="p-6 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-base font-bold leading-none">PayFlowX</h1>
      ...
      <main className="flex-1 flex flex-col overflow-hidden min-w-0">
        <header className="h-16 border-b border-[#282839] bg-[#101022] flex items-center justify-between px-8 shrink-0">
          <div className="flex items-center gap-8">
            <h2 className="text-lg font-bold tracking-tight">Payments</h2>
          ...
          <div className="flex items-center gap-4">
            ...
            <button type="button" className="size-10 rounded-lg flex items-center justify-center bg-[#282839] text-white">
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar bg-[#101022]">
          <div className="max-w-6xl mx-auto p-8">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-medium text-white">Scheduled Payments</span>
            </div>
            <div className="flex flex-wrap justify-between items-end gap-4 mb-8">
              <div>
                <h1 className="text-3xl font-black tracking-tight">Scheduled Payments</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="bg-[#111118] border border-[#3b3b54] rounded-xl p-5">
                ...
                <div className="flex items-baseline gap-2">
                  <p className="text-2xl font-bold">$142,500.00</p>
              ...
              <div className="bg-[#111118] border border-[#3b3b54] rounded-xl p-5">
                ...
                <div className="flex items-baseline gap-2">
                  <p className="text-2xl font-bold">$32,400.00</p>
                  ...
                  <tbody className="divide-y divide-[#282839]">
                    {schedules.map((s) => (
                      <tr key={s.name} className="group hover:bg-[#1a1a2e] transition-colors">
                        ...
                        <td className="px-6 py-4">
                          <p className="text-sm font-medium">{s.nextRun}</p>
          ...
          <div className="bg-[#111118] w-full max-w-xl rounded-2xl shadow-2xl border border-[#3b3b54] overflow-hidden flex flex-col" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-6 space-y-5 overflow-y-auto max-h-[70vh] custom-scrollbar">
              <div>
                ...
                <input type="text" defaultValue="Q4 Contractor Payments" className="w-full bg-[#1a1a2e] border border-[#282839] rounded-lg px-4 py-2.5 text-sm focus:ring-1 focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)] outline-none transition-all text-white" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">Frequency</label>
                  <select className="w-full bg-[#1a1a2e] border border-[#282839] rounded-lg px-4 py-2.5 text-sm focus:ring-1 focus:ring-[var(--color-primary)] outline-none appearance-none text-white">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="text" defaultValue="Oct 01, 2023" className="w-full bg-[#1a1a2e] border border-[#282839] rounded-lg px-4 py-2.5 text-sm focus:ring-1 focus:ring-[var(--color-primary)] outline-none text-white pr-10" />
                  </div>
                </div>
              </div>
              <div>
                ...
                <div className="bg-[#1a1a2e] border border-[#282839] rounded-lg p-2.5 flex flex-wrap gap-2">
                  ...
                  <input type="text" placeholder="Add more..." className="flex-1 min-w-[120px] bg-transparent border-none p-0 text-sm focus:ring-0 outline-none text-white placeholder:text-slate-500" />
                </div>
              </div>
            ...
            <div className="p-6 bg-slate-900/40 border-t border-[#282839] flex justify-end gap-3">
              <button type="button" onClick={() => setModalOpen(false)} className="px-5 py-2 rounded-lg text-sm font-bold text-slate-500 hover:bg-[#282839] transition-all">Discard</button>
