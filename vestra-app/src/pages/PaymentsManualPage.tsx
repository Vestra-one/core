      ...
      <main className="flex-1 max-w-[1440px] mx-auto w-full px-4 lg:px-10 py-8 min-h-0 overflow-auto">
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
          ...
          <Link
            ...
            className="flex min-w-[120px] items-center justify-center gap-2 rounded-lg h-11 px-5 bg-[var(--color-primary)] text-white text-sm font-bold shadow-lg hover:opacity-90 transition-all"
          >
                      ...
                      >
                        <td className="px-6 py-4">
                          <input
                            ...
                            className="w-full bg-transparent border-none focus:ring-0 text-sm font-medium text-slate-900 dark:text-white placeholder:text-slate-500 dark:placeholder:text-slate-700"
                        ...
                        <td className="px-6 py-4">
                          <button
                            type="button"
                            className="flex items-center justify-between gap-2 px-3 h-9 rounded-lg bg-[var(--color-surface-dark)] border border-[var(--color-border-darker)] text-slate-900 dark:text-white text-xs font-semibold w-full"
                          >
                        ...
                        <td className="px-6 py-4 text-right">
                          <div className="flex items-center justify-end gap-2">
                            <input
                              ...
                              className="bg-transparent border-none focus:ring-0 text-right text-sm font-bold w-24 text-slate-900 dark:text-white"
                            />
                    ...
                    <tr className="bg-white/[0.02]">
                      <td className="px-6 py-4">
                        <input
                          ...
                          className="w-full bg-transparent border-none focus:ring-0 text-sm text-slate-900 dark:text-white placeholder:text-slate-500 dark:placeholder:text-slate-600"
                        />
                      </td>
                      <td className="px-6 py-4">
                        <button
