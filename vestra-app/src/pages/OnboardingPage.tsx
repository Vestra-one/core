          ...
          <div className="flex flex-col gap-3">
            <div className="flex gap-6 justify-between items-end">
              <p className="text-slate-400 text-sm font-medium uppercase tracking-wider">
                Step 3 of 4: Notification Setup
              </p>
              <p className="text-[var(--color-primary)] text-sm font-bold">
                75% Complete
              </p>
            </div>
          ...
          <div className="bg-[#1c1c27] rounded-xl shadow-xl border border-[#2b2b3d] overflow-hidden">
            <div className="p-8 border-b border-[#2b2b3d] text-center">
              ...
              <p className="text-slate-400 text-sm">
                Choose how you want to be notified about transaction updates,
            ...
            <div className="p-8 space-y-8">
              <div className="flex flex-col gap-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <Icon
                      ...
                      size={24}
                    />
                    <label htmlFor="email-toggle" className="font-semibold">
                      Email Notifications
                    </label>
                  </div>
                ...
                <input
                  ...
                  className="w-full bg-[#111118] border border-[#3b3b54] rounded-lg px-4 py-3 text-sm focus:ring-2 focus:ring-[var(--color-primary)] outline-none"
                />
              </div>
              ...
              <div className="flex flex-col gap-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <Icon
                      ...
                      size={24}
                    />
                    <label htmlFor="sms-toggle" className="font-semibold">
                      SMS Security Alerts
                    </label>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                ...
                <div className="flex gap-2">
                  ...
                  <input
                    ...
                    className="flex-1 bg-[#111118] border border-[#3b3b54] rounded-lg px-4 py-3 text-sm focus:ring-2 focus:ring-[var(--color-primary)] outline-none"
                  />
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-slate-500 px-1">
                    Trigger automated workflows in your own system on payment
                    success.
                  </p>
                </div>
              </div>
            ...
            <div className="p-8 bg-[#161622] flex flex-col gap-4">
              <button
                type="button"
                className="w-full bg-[var(--color-primary)] hover:opacity-90 text-white font-bold py-4 rounded-xl shadow-lg transition-colors flex items-center justify-center gap-2"
              >
                Confirm Setup
              ...
              <button
                type="button"
                className="w-full text-center text-sm font-medium text-slate-500 hover:text-[var(--color-primary)] transition-colors"
              >
                Save & continue later
              </button>
            </div>
